defmodule Mix.Tasks.Bh.Gen.Live do
  ...
  types.  See `mix help bh.gen.schema` for more information on attributes.
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix bh.gen.live Accounts User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix bh.gen.live Accounts User users --web Sales
  ...
  use binary ids for primary keys, see `mix help bh.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix bh.gen.live must be invoked from within your *_web application root directory"
    end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/bh.gen.live", binding, files)
