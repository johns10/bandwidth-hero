defmodule BandwidthHero.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, BandwidthHero.Repo)
  ...
  """
  def valid_password?(%BandwidthHero.Accounts.User{hashed_password: hashed_password}, password)
