defmodule BandwidthHeroWeb.ContractorErpTagLive.FormHandlers do
  ...
  def save_redirect(socket, action, contractor_erp_tag_params)
      when action in [:edit, :edit_erp_tag] do
    case ContractorErpTags.update_contractor_erp_tag(
           socket.assigns.contractor_erp_tag,
           contractor_erp_tag_params
         ) do
  ...
  def save_redirect(socket, action, contractor_erp_tag_params)
      when action in [:new, :new_erp_tag] do
  ...
  def save_no_redirect(socket, :new, contractor_erp_tag_params) do
    case ContractorErpTags.create_contractor_erp_tag(contractor_erp_tag_params) do
      {:ok, _contractor_erp_tag} ->
        changeset =
          ContractorErpTags.change_contractor_erp_tag(
            %BandwidthHero.ContractorErpTags.ContractorErpTag{}
          )
