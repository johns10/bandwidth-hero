defmodule BandwidthHeroWeb.ContractorLive.Show do
  ...
  def handle_params(%{"id" => id} = attrs, _, socket) do
    contractor = Contractors.get_contractor!(id, [preloads: [contractor_erp_tags: true]])
  ...
  def handle_event("delete-contractor-erp-tag", %{"id" => id}, socket) do
    ...
    contractor = Contractors.get_contractor!(socket.assigns.contractor.id, [preloads: [contractor_erp_tags: true]])
